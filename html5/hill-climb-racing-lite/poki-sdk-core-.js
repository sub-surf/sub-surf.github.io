                            ...
                            return new Promise((function (n) {
                                if (i.ignoreEvents())
                                    return _.debug && console.error("commercialBreak ignored because of too many events"),
                                        void n();
                                var o = i.gameStarted ? e.ads.position.rewarded : e.ads.position.preroll;
                                adBreak({
                                    type: "reward",
                                    name: "free-money",
                                    beforeAd: () => {
                                    ...
                                    adDismissed: () => {
                                        console.log("Not earned the reward, skipped early.");
                                    },
                                    adViewed: () => {
                                        n;
                ...
                new Promise((function (e, t) {
                    return An(void 0, void 0, void 0, (function () {
                        ...
                        return hn(this, (function (y) {
                            switch (y.label) {
                                case 0:
                                    return console.info("PLAYTEST:%c showing consent screen", "font-weight: bold", ""),
                ...
                return n.track = function (t, i) {
                    ...
                    if (t.includes("pokiTrackingRewardedWeb") && (a = s),
                        ...
                        if ("test" === (null === (r = null === (o = null === window || void 0 === window ? void 0 : window.process) || void 0 === o ? void 0 : o.env) || void 0 === r ? void 0 : r.NODE_ENV))
                            return;
                        Object.keys(a).length ? console.info("TRACKER:%c Tracked event '".concat(t, "' with data:"), "font-weight: bold", "", a) : console.info("TRACKER:%c Tracked event '".concat(t, "'"), "font-weight: bold", "")
                    }
                    !function (e) {
                ...
                , s = [{
                    ...
                    bids: [{
                        ...
                        params: {
                            organizationId: "",
                            site: "",
                            placement: "".concat(I.device, "ingame_320x50"),
                            environment: I.device,
                            useAdUnitCodeAsAdUnitElementId: !0,
                            pagetype: "game",
                            category: "games"
                        ...
                        if (d && (A = A.replace("cust_params=", "cust_params=".concat(d, "%26"))),
                            ...
                            if (d) {
                                var g = function (e) {
                                    ...
                                    return {
                                        bid: i,
                                        vast: "vast?b=".concat(o, "&rnd=").concat(Math.round(1e10 * Math.random()), "&pp=").concat(n)
                                    }
                                }(d);
                            ...
                            switch (h.bidder) {
                                case "onetag":
                                    A = "invocation/?key=".concat(h.videoCacheKey);
                                    break;
                                case "rubicon":        
                                    break;
                                case "spotx":
                                ...
                                case "poki":
                                    ...
                                    break;
                                default:
                                    A = "pbc/v1/cache?uuid=".concat(h.videoCacheKey)
                            }
                            R({
                                event: "video-ready",
                ...
                this.slotMap = new Map,
                    ...
                    this.requestHouseAd = function (t, n) {
                        ...
                        R(wo(wo({}, i), {
                            ...
                            fetch("".concat(t.width, "x").concat(t.height, "?game_id=").concat(I.gameID, "&site=").concat(I.siteID)).then((function (e) {
                                return e.json()
                            }
                            )).then((function (o) {
                        ...
                        return Promise.allSettled(h).then((function (n) {
                            ...
                            try {
                                ...
                                if ("fulfilled" === a.status) {
                                    ...
                                    if (!(c && c.gameID || _.debug || "test" !== (null === (o = null === (i = null === window || void 0 === window ? void 0 : window.process) || void 0 === i ? void 0 : i.env) || void 0 === o ? void 0 : o.NODE_ENV))) {
                                ...
                                switch (g.label) {
                                    ...
                                    case 2:
                                        return v.push(L("https://s.net/tag/js/gpt.js")),
                                            l || v.push(L("https://www.gamegab.com/content/games/hill-climb-racing-lite/scr2.js")),
                        ...
                        return e.criteria = Po(Po(Po({
                            ...
                            !I.kioskMode && (_.debug ? (this.display.renderAd(e),
                                !0) : this.strictConsentMode && !this.monetizationCoreLoaded ? (console.error("%cPOKI_ADS:%c", "font-weight: bold", "", "Ad libraries not yet loaded"),
                                    !1) : this.GPTRejected ? (console.error("ADS:%c", "font-weight: bold", "", "Bot, IMA or Adblocker error"),
                                        !1) : jn() ? (console.error("ADS:%c", "font-weight: bold", "", "No TCFv2 CMP detected, please contact developersupport@poki.com for more information"),
                                            !1) : Nn() ? (console.error("ADS:%c", "font-weight: bold", "", "No USP detected, please contact developersupport@poki.com for more information"),
                                                !1) : n ? this.sdkBooted ? t ? void 0 === window.googletag ? (console.error("ADS:%c", "font-weight: bold", "", "Adblocker has been detected"),
                                                    !1) : this.adSettings.countryExclusion.includes(I.country) ? (console.error("ADS:%c", "font-weight: bold", "", "Country is excluded from ads"),
                                                        !1) : this.display.validateDisplaySettings(n) ? (this.display.renderAd(e),
                                                            !0) : (console.error("ADS:%c", "font-weight: bold", "", "Display size ".concat(n, " is not supported on this device")),
                                                                !1) : (console.error("ADS:%c", "font-weight: bold", "", "Provided container does not exist"),
                                                                    !1) : (console.error("ADS:%c", "font-weight: bold", "", "Requesting ad on unbooted SDK"),
                                                                        this.sdkNotBootedButCalled(),
                                                                        !1) : (console.error("ADS:%c", "font-weight: bold", "", "No ad size given, usage: displayAd(<container>, <size>)"),
                                                                            !1))
                    }
                    ,
                    t.prototype.destroyAd = function (e) {
